...
export async function POST() {
  ...
  const lead: Lead = {
    ...
    activity: ["Demo scenario completed", "AI qualified lead as Hot", "Suggested action: book discovery call", "Lead added to Qualified pipeline"]
  };

  await upsertLead(lead);
  return NextResponse.json({ lead, message: "Demo scenario completed: new Hot lead qualified." });
}
